...
public class HibernateConfiguration {
    ...
    //Hibernate config conté la configuració comú per a les BD
    ...
    //Al fitxer de cofig de hibernate.properties, hibernate.hbm2ddl = update fa que es crein
    //les taules necesaries per normalitzar la bd o crearla sencera al nostre esquema
