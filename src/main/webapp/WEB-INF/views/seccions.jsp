<%-- 
    Document   : selecSeccio
    Created on : 20-ago-2020, 10:08:11
    Author     : JoseAndrade
--%>
                ...
                <c:forEach items="${seccions}" var="seccions">
                    <div class="col-sm-6 col-md-3" style="padding-bottom: 15px">
                        <div class="thumbnail">
                            <div class="caption">
                                <h3>#${seccions.nom}</h3>                              
                                <p>${seccions.tipusProduccio}</p>                            
                                <p>
                                    <a href=" <spring:url value= '/seccio/seccio?seccioId=${seccions.idSeccio}' /> " class="btn btn-primary">
                                        <span class="glyphicon glyphicon-pencil glyphicon"/></span> modificar 
                                    </a>
                                    <a href=" <spring:url value= '/seccio/delete?idSeccio=${seccions.idSeccio}' /> " class="btn btn-danger">
